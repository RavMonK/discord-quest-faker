...
| โปรเซสปลอมมีหน้าต่างจริง | คอมไพล์โปรแกรมเล็ก ๆ ตอนเริ่ม (`csc.exe` / `clang` / `cc`) โชว์ชื่อเกม + เวลาที่เดินมาแล้ว |
...
| คิว | กด **＋** เรียงเกมไว้: แต่ละตัวเล่นตามเวลาของมัน แล้วตัวถัดไปเริ่มหลังเว้นระยะสุ่ม 30-70 วิ |
| auto-stop | ตั้งเวลาให้หยุดเองเป็นนาที |
| เกมนอกลิสต์ | เพิ่มเองได้จาก Steam app id / SteamDB URL |
| ข้ามแพลตฟอร์ม | Windows (เต็มรูปแบบ), macOS / Linux (มีหน้าต่างเหมือนกัน แต่เกมน้อยกว่ามาก — ดู [ความต่างของแต่ละระบบ](TH-Platform-Notes)) |
